			...
			{ loading ? (
        		...
        		<>
            		<Flex w='full' py='5' direction='column'>
						<Grid templateColumns={{ sm:'1fr' ,md: '2fr 1fr', lg: '3fr 2fr'}}  gap='20'>
							{/* Column 1 */}
							...
							{/* Shipping */}
								...
								<Box borderBottom='1px' py='6' borderColor='gray.300'>
									...
									<Text mt='4'>
										{order.isPaid ? (
											<Message type='success'>Paid on {order.paidAt.substring(0, 10)}
											</Message>
										) : (
							...
							<Flex
								...
								<Flex
									...
									alignitems='center'
									justifyContent='space-between'>
									<Text fontSize='xl'>Items Price</Text>
								...
								<Box>
									{loadingPay ? (
										...
										<PayPalScriptProvider
											options={{
												'client-id':
													'AXh5FJ5Uy89tcm5fYmAVM5P_RK6Sp8lcEk6C17kTWz45dsU7TUJ_V9oLNBixqqAj2ntKjhcEKwH_Qo2v',
												components: 'buttons',
											}}>
											<PayPalButtons
							...
							!order.isDelivered && (
								<Button
									type='button' colorScheme='teal' bgColor='teal.800'
