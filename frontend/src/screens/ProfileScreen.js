                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <FormControl id='email'>
                            ...
                            <Input
                                id='email'
                                type='email'
                                placeholder='username@domain.com' value={email} onChange={(e) => setEmail(e.target.value)}
                            />
                        </FormControl>
                        ...
                        <Button type='submit' bgColor='teal.800' colorScheme='teal' mt='4' isLoading={loading}>
                            Update
                        </Button>
                    </form>
                </FormContainer>
