    ...
    return (
        <>
            ...
            <Flex mb='5'>
                ...
                to='/' bgColor='teal.800' colorScheme='teal'>
                    Go Back
                </Button>
            </Flex>
            ...
            {loading ? (
                ...
                <>
                    <Grid templateColumns={{sm:'1fr' ,md:'4fr 3fr 2fr', lg:'5fr 4fr 3fr'}} gap='10'>
                        {/* Column 1 */}
                        {/* Display Image */}
                        ...
                        <Flex direction='column'>
                            {/* Display Brand Name */}
                            <Heading as='h5' color='gray.500' fontSize='base'>
                                {product.brand}
                            </Heading>
							...
							<Box
								...
								{userInfo ? (
									<form onSubmit={submitHandler}>
										...
										<Button colorScheme='teal' bgColor='teal.800' type='submit'>
											Post Review
										</Button>
									</form>
								) : (
